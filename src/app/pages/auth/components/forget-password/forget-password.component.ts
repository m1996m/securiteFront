...
export class ForgetPasswordComponent {
  ...
  forgetPassword(){
    this.notificationService.success('Mot de passe oublié', "Creation d'un nouveau mot de passe avec succèss");
    this.authService.forgetPassword(this.formBulder.value).subscribe((data)=>{})
  }
}
